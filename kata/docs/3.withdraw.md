...
### Passing test(s)
:red_circle: Let's write our next test (Existing account with enough money & a withdraw of 900 -> store the updated account containing a negative transaction of 900)
...
✅ Existing account -> return a failure for a withdraw of 0
✅ Existing account with not enough money & a withdraw of 100 -> return a failure because "not enough money available" 
Existing account containing 1000 for a withdraw of 1000 -> store the updated account containing a negative transaction of 1000
```
